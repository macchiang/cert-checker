...
| service.service.port | int | `8080` |  |
| service.service.type | string | `"ClusterIP"` |  |
| service.uiService.port | int | `8081` |  |
| service.uiService.type | string | `"ClusterIP"` |  |
